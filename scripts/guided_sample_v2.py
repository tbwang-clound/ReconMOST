...
def main():
    ...
    guided_arr_dict = get_guided_arr_dict(args.sparse_data_path, args.in_channels)  # 获取完整的arr,-5-40
    ...
    def cond_fn(x, t, p_mean_var, y=None):
        ...
        # 该函数还支持分组卷积和跨通道卷积，在后面3D任务时可以实现上下层相互影响
        return gradient * s
